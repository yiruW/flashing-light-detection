...
####### HSV or BGR #######
        ...
        mask_blue_hsv = cv2.inRange(resized, lower_blue_hsv, upper_blue_hsv)
        mask_red_hsv = cv2.inRange(resized, lower_red_hsv, upper_red_hsv)
        ...
        result_blue_hsv = cv2.bitwise_and(resized,resized, mask= thresh_mask_blue_hsv)
        result_red_hsv = cv2.bitwise_and(resized,resized, mask= mask_red_hsv)

        contours, hierarchy = cv2.findContours(thresh_mask_blue_hsv, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE) 
        contours, hierarchy = cv2.findContours(mask_red_hsv, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
